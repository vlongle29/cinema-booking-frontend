         ...
         <div className="bg-[#1a1a1e] border border-[#393939] rounded-[8px] p-5 shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
               ...
               <div className="space-y-1.5">
                  <label className="text-[#797b7d] text-[10px] uppercase font-bold tracking-wider">
                     Keyword
                  </label>
               ...
               <div className="space-y-1.5">
                  ...
                  <input
                     ...
                     value={searchParams.releaseDateFrom}
                     onChange={handleSearchChange}
               ...
               <div className="space-y-1.5">
                  ...
                  <input
                     type="date"
                     name="releaseDateTo"
                     value={searchParams.releaseDateTo}
                     onChange={handleSearchChange}
                     className="w-full bg-[#252529] border border-[#393939] rounded-[6px] px-3 py-2 text-white text-xs focus:outline-none focus:border-[#f84565] [color-scheme:dark] transition-colors"
                  />
               </div>
            ...
            <div className="flex justify-end mt-4 gap-2 border-t border-[#393939] pt-4">
               <button
                  ...
                  className="flex items-center gap-1.5 px-4 py-2 bg-[#252529] hover:bg-[#2d2d33] text-[#d1d5dc] text-xs font-semibold rounded-[6px] border border-[#393939] transition-all"
               >
         ...
         {isLoadingList ? (
            ...
            <div className="bg-[#1a1a1e] border border-[#393939] rounded-[8px] overflow-hidden shadow-sm">
                  ...
                  <table className="w-full text-left border-collapse">
                     <thead>
                        <tr className="bg-[#252529] border-b border-[#393939]">
                           <th className="px-6 py-4 text-[10px] font-bold text-[#797b7d] uppercase tracking-wider">
                              Movie
                           </th>
                           <th className="px-6 py-4 text-[10px] font-bold text-[#797b7d] uppercase tracking-wider">
                              Director & Cast
                           ...
                           <th className="px-6 py-4 text-[10px] font-bold text-[#797b7d] uppercase tracking-wider text-right">
                              Actions
                           </th>
                        </tr>
                     </thead>
                           ...
                           >
                              <td className="px-6 py-8">
                                 <div className="flex items-center gap-4">
                                    <div className="w-20 h-28 rounded-[4px] bg-[#252529] flex-shrink-0 overflow-hidden border border-[#393939]">
                                       <img
                                    ...
                                    <div className="max-w-[200px]">
                                       <p className="text-white text-sm font-semibold truncate group-hover:text-[#f84565] transition-colors">
                                          {movie.title}
                                       </p>
                              ...
                              <td className="px-6 py-4">
                                 <span
                                    className={`px-2 py-1 rounded-[4px] text-[10px] font-bold uppercase tracking-wider ${movie.status === "SHOWING" ? "bg-emerald-500/10 text-emerald-400 border border-emerald-500/20" : movie.status === "COMING_SOON" ? "bg-blue-500/10 text-blue-400 border border-blue-500/20" : "bg-gray-500/10 text-gray-400 border border-gray-500/20"}`}
                                 >
               ...
               <div className="flex items-center justify-between px-6 py-4 bg-[#252529] border-t border-[#393939]">
                  <div className="text-[#797b7d] text-xs">
                     Found{" "}
                  ...
                  <div className="flex items-center gap-4">
                     ...
                     <div className="flex items-center gap-2">
                        <button
                           ...
                           disabled={searchParams.page === 1 || isLoadingList}
                           className="p-2 bg-[#1a1a1e] border border-[#393939] rounded-[6px] text-white hover:bg-[#2d2d33] transition-colors disabled:opacity-30 disabled:cursor-not-allowed"
                        >
            ...
            <div className="bg-[#1a1a1e] border border-[#393939] rounded-[8px] p-24 text-center">
               <div className="max-w-xs mx-auto">
                  ...
                  <p className="text-[#797b7d] text-sm mb-6">
                     We couldn't find any movies matching your filters. Try
                     adjusting your search criteria.
                  </p>
                  <button
                     onClick={resetFilters}
                     className="px-6 py-2 bg-[#f84565] text-white font-semibold rounded-[6px] hover:bg-[#f84565]/90 transition-all text-sm"
                  >
                     Clear All Filters
                  </button>
               </div>
